...
public class ColorPicker extends SettingsPage {
    Logger logger = new Logger("Silent Typing Fix ColorPicker");
    ...
    public void onViewBound(View view) {
        ...
        keyboardView.setImageDrawable(neutered.keyboard);

        disableIconView.setImageDrawable(neutered.disableImage);
    ...
    public void setSettings(){
        SettingsAPI api = neutered.Settings;
    ...
    public SeekBar createSeekBar(String name){
        ...
        sb.setProgress(neutered.Settings.getInt(category  + name,defvalue));
    ...
    public void changeCategory() {
        seekBarList.forEach((s, seekBar) -> {
            ...
            seekBar.setProgress(neutered.Settings.getInt(category + s,defVal));
        });
